...
/*!*****************************************!*\
  !*** ./src/modules/open-weather-api.js ***!
  \*****************************************/
/*! exports provided: searchWeatherByCity, searchWeatherByCoordinates */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"searchWeatherByCity\", function() { return searchWeatherByCity; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"searchWeatherByCoordinates\", function() { return searchWeatherByCoordinates; });\n/* harmony import */ var _weather_container__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./weather-container */ \"./src/modules/weather-container.js\");\n/* harmony import */ var _flickr_api__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./flickr-api */ \"./src/modules/flickr-api.js\");\n\n\n// \"http://openweathermap.org/img/w/\" + iconcode + \".png\"; icon of json\nconst searchWeatherByCity = (cityName) => {\n  Object(_flickr_api__WEBPACK_IMPORTED_MODULE_1__[\"setCityPhoto\"])(cityName);\n  const url = 'https://api.openweathermap.org/data/2.5/weather?q='+\n              cityName+\n              '&appid='+\"b2c7b3deb8732cf9b04f84cbc84ffbfd\"+'&units=metric';\n  getData(url);\n}\nconst searchWeatherByCoordinates = (lat,long) => {\n  const url = 'https://api.openweathermap.org/data/2.5/weather?lat='+\n              lat+'&lon='+long+'&appid='+\"b2c7b3deb8732cf9b04f84cbc84ffbfd\"+\n              '&units=metric';\n              console.log(lat,long);\n  getData(url);\n}\n\nconst getData = (url) => {\n  fetch(url)\n  .then(response => response.json())\n  .then(json => {\n    console.log(json);\n      const obj = {\n        title: json.name,\n        description: json.weather[0].main,\n        icon: json.weather[0].icon,\n        temperature: Math.round(json.main.temp)+'°C',\n        humidity: json.main.humidity+'%',\n        windSpeed: json.wind.speed,\n        minTemp: Math.round(json.main.temp_min)+'°C',\n        maxTemp: Math.round(json.main.temp_max)+'°C'\n      };\n\n      Object(_weather_container__WEBPACK_IMPORTED_MODULE_0__[\"setData\"])(obj);\n\n  }).catch(err => console.log(err));\n}\n\n\n\n\n\n//# sourceURL=webpack:///./src/modules/open-weather-api.js?");
...
/*!******************************************!*\
  !*** ./src/modules/weather-container.js ***!
  \******************************************/
/*! exports provided: weatherContainer, setData, convertToCelcius, convertToFahrenheit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"loadDOM\", function() { return loadDOM; });\n/* harmony import */ var _styles_style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles/style.css */ \"./src/styles/style.css\");\n/* harmony import */ var _styles_style_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_styles_style_css__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _modules_nav_container__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/nav-container */ \"./src/modules/nav-container.js\");\n/* harmony import */ var _modules_search_bar__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/search-bar */ \"./src/modules/search-bar.js\");\n/* harmony import */ var _modules_weather_container__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/weather-container */ \"./src/modules/weather-container.js\");\n/* harmony import */ var _modules_open_weather_api__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/open-weather-api */ \"./src/modules/open-weather-api.js\");\n/* harmony import */ var _modules_temperature_utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/temperature-utils */ \"./src/modules/temperature-utils.js\");\n\n\n\n\n\n\nconst loadDOM = () => {\n\n  const body = document.getElementsByTagName('body')[0];\n   body.appendChild(_modules_search_bar__WEBPACK_IMPORTED_MODULE_2__[\"searchContainer\"]);\n   body.appendChild(_modules_weather_container__WEBPACK_IMPORTED_MODULE_3__[\"weatherContainer\"]);\n    Object(_modules_open_weather_api__WEBPACK_IMPORTED_MODULE_4__[\"searchWeatherByCity\"])('London');\n\n}\n\n\n\n\n\n//# sourceURL=webpack:///./src/pageLoader.js?");
