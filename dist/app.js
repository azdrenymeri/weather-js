...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nconst searchWeatherByCity = async cityName => {\n  const url = `https://api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=${\"b2c7b3deb8732cf9b04f84cbc84ffbfd\"}&units=metric`;\n  try {\n    const response = await fetch(url);\n    return response.json();\n  } catch (err) {\n    return err;\n  }\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (searchWeatherByCity);\n\n\n//# sourceURL=webpack:///./src/modules/open-weather-api.js?");
